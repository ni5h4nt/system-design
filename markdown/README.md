...
| [Cursor BugBot](design-bugbot.md) | AI code review: automated PR review with diff analysis, multi-model cascade, and precision-focused feedback at scale. | Review depth vs. latency — model cascade with ephemeral analysis |
